          ...
          arrows: {
           ...
           <SplideSlide>
            <Link to='https://news.milli.az/culture/1197384.html'>
             <MediaItem img={media2} title="Fidan Hacıyeva Beynəlxalq Opera Festivalının proqramı təqdim olunub" date='17 Aprel 2024 13:09
              ' site='news.milli.az' />
            </Link>
           ...
           <SplideSlide>
            <Link to='https://news.milli.az/culture/1178358.html'>
             <MediaItem img={media2} title="Azərbaycanda Fidan Hacıyevanın birincı Beynəlxalq Opera Festivalı keçiriləcək." date='26 Yanvar 2024 18:23' site='news.milli.az' />
            </Link>
           ...
           <SplideSlide>
            <Link to='https://azertag.az/xeber/fidan_haciyeva_beynelxalq_vokal_festivali_opera_musiqisi_dinlemek_isteyen_her_kesi_ehate_edecek-2796325'>
             <MediaItem img={media2} title="Fidan Hacıyeva: Beynəlxalq Vokal Festivalı opera musiqisi dinləmək istəyən hər kəsi əhatə edəcək." date='21.10.2023 [12:30]
              ' site='news.milli.az' />
            </Link>
