                ...
                <Box className='footer-up'>
                    <FramerMotion 
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', maxWidth: '500px', margin: '20px 80px',gap:'10px' }} className='footer-info-container'>
                            ...
                            <Link to='http://www.philharmonichall.az/'> <img src={filar} className='w-32 mt-2 mx-2' alt='Filar' /> </Link>
                            <Link to='https://icm.az/'> <img src={mugam} className='w-24 mt-2 mx-2' alt='Mugam' /> </Link>
                            <Link to='https://www.facebook.com/search/top?q=fidan%20hac%C4%B1yevan%C4%B1n%20vokal%20musiqi%20m%C9%99kt%C9%99bi'> <img src={mekteb} className='h-28 w-32  mt-[-4] mx-2' alt='Mekteb' /> </Link>
                        </Box>
                    </FramerMotion>
